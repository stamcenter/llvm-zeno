...
const char *TargetInfo::getTypeName(IntType T) {
  ...
  case SignedIntNS:     return "__int128_t";
  case UnsignedIntNS:   return "__uint128_t";
  }
}
...
const char *TargetInfo::getTypeConstantSuffix(IntType T) const {
  ...
  case SignedIntNS:      return "UN";
  case UnsignedIntNS:    return "N";
  }
}
...
unsigned TargetInfo::getTypeWidth(IntType T) const {
  ...
  case SignedIntNS:
  case UnsignedIntNS:    return getPointerWidth(0);
  };
}
...
TargetInfo::IntType TargetInfo::getIntTypeByWidth(
  ...
  if(getPointerWidth(0) == BitWidth)
    return IsSigned ? SignedIntNS : UnsignedIntNS;
  return NoInt;
}
...
unsigned TargetInfo::getTypeAlign(IntType T) const {
  ...
  case SignedIntNS:
  case UnsignedIntNS:    return getPointerAlign(0);
  };
}
